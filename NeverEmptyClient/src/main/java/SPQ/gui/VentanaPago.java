...
public class VentanaPago extends JFrame implements ActionListener{
	...
	//Componentes VISA
	JLabel cardnumber, cardholder, lExpDate, lCvv;
	
	JTextField expDateDay, expDateMonth, cvv;
	
	JLabel lAltCardnumber, lAltcardholder;
	JTextField altCardnumber1, altCardnumber2, altCardnumber3, altCardnumber4;
	JTextField altcardholder;
	JLabel lAltExpDate, lAltCvv;
	JTextField altExpDateDay, altExpDateMonth, altCvv;
	
	
	//Componentes PayPal
	JLabel lPaypalUsername, lPayPalPassword;
	JPasswordField pfPaypalPassword;
	
	JLabel lAltPaypalUsername, lAltPaypalPassword;
	JTextField altPaypalUsername;
	JPasswordField pfAltPayPalPassword;
	...
	public VentanaPago (NeverEmptyController neverEmptyController , String paymentMethod) {
	...
	private void loadVisaComponents() {
		...
		this.cardnumber = new JLabel("Número de tarjeta: " + Integer.toString(user.getCardNumber()));
	...
	private void loadPayPalComponents() {
		...
		this.pfAltPayPalPassword.setText(user.getPayPalPassword());
	...
	public static void main(String[] args) {
		...
		VentanaPago vp = new VentanaPago(nec, "paypal");
		vp.setVisible(true);
	}
